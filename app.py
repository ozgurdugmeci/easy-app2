...
if yan_sayfa_secenek == 'Analyses' :
 ...
 that may impact sales can make it more comprehensive and accurate.</br> </br> <b> Model </b> </br> </br> 1- Getting data from Snowflake Cloud (Sales and Inventory Quantity Data) </br> \
